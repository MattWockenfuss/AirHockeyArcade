...
struct Bike {
	public:
		...
		void draw1(sf::RenderTexture* window1, double screenRatio, sf::RectangleShape& rect, sf::Text& text, sf::Color& color);
		void draw2(sf::RenderTexture* window2, double screenRatio, sf::RectangleShape& rect, sf::Text& text, sf::Color& color);
};
