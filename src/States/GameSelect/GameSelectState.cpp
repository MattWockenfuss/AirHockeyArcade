...
void GameSelectState::init(Context* ctx){
	...
	gameOptions.push_back( GameOption("Tron", "Play first to 7 on fast-paced light bikes from the future!", ctx->assets->getAsset("bTronIcon"), sf::Color(255,255,255), sf::Color(200,200,255) ));
